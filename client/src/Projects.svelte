  ...
  let projects = [
    {
      ...
      description: 'A personal portfolio website engineered using a modern full-stack development framework. \
    ...
    {
      title: 'GPTFit',
      description: "A web application developed to simplify and personalize the creation of exercise programs. \
      ...
      The integration of AI into the fitness domain exemplifies the potential of machine learning in personalizing digital experiences.",
    },
    {
      title: 'Quiz Generation',
      description: "An extensive toolkit for generating and evaluating quizzes from academic content using OpenAI's API. \
      This tool enables educators to automate quiz creation, enhancing efficiency and diversity of questions. \
      Evaluating capability ensures the quality and relevance of generated questions. This project underlines the power of AI in improving the educational sector.I",
    },
    {
      title: 'Simple RSA Messager',
      description: 'The project is a secure messaging system that employs RSA, a public-key cryptography protocol, to safeguard the messages exchanged between a client and a server. \
    ...
    },
    {
      ...
      description: 'A high-performance asynchronous program developed in Rust, \
      designed to interface with an embedded system over MQTT (Message Queuing Telemetry Transport). \
      This system serves as a communication bridge, allowing commands and data to be relayed between the program and the embedded system. \
      It has applications in real-time testing, validation, and troubleshooting of the connected system.',
    },
    {
      title: '2048 Game',
      description: 'An interactive recreation of the popular 2048 game. \
